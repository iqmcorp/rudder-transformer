...
async function userTransformHandlerV1(events, userTransformation, libraryVersionIds, testMode = false) {
    /*
    ...
    */
    if (userTransformation.versionId) {
        ...
        const isolatevmFactory = await getFactory(userTransformation.code, libraryVersionIds, userTransformation.versionId, userTransformation.secrets || {}, testMode);
...
//# sourceMappingURL=customTransformer-v1.js.map