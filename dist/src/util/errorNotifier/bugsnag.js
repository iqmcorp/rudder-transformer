...
const { CustomError: CDKCustomError, DataValidationError, } = require('rudder-transformer-cdk/build/error/index');
const stackTraceParser = require('stacktrace-parser');
const { logger } = require('../../logger');
const pkg = require('../../../package.json');
const { BaseError, TransformationError, ConfigurationError, InstrumentationError, PlatformError, OAuthSecretError, NetworkError, ThrottledError, RetryableError, InvalidAuthTokenError, AbortedError, UnhandledStatusCodeError, UnauthorizedError, NetworkInstrumentationError, } = require('../../v0/util/errorTypes');
