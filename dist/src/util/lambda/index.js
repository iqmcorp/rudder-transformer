...
const { LambdaClient, CreateFunctionCommand, GetFunctionCommand, InvokeCommand, UpdateFunctionCodeCommand, waitUntilFunctionActiveV2, waitUntilFunctionUpdatedV2, } = require('@aws-sdk/client-lambda');
...
const LAMBDA_EVENT_SIZE_LIMIT_IN_MB = parseInt(process.env.EVENT_SIZE_LIMIT_IN_MB || '3', 10) * 1024 * 1024;
...
const createZip = async (userCode) => new Promise((resolve, reject) => {
    const zip = new JSZip();
