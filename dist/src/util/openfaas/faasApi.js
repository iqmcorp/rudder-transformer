...
const deleteFunction = async (functionName) => new Promise((resolve, reject) => {
...
const getFunction = async (functionName) => new Promise((resolve, reject) => {
...
const getFunctionList = async () => new Promise((resolve, reject) => {
    const url = `${OPENFAAS_GATEWAY_URL}/system/functions`;
    axios
        .get(url)
        .then((resp) => resolve(resp.data))
...
const invokeFunction = async (functionName, payload) => new Promise((resolve, reject) => {
...
const checkFunctionHealth = async (functionName) => new Promise((resolve, reject) => {
    const url = `${OPENFAAS_GATEWAY_URL}/function/${functionName}`;
    axios
        .get(url, {
...
const deployFunction = async (payload) => new Promise((resolve, reject) => {
    const url = `${OPENFAAS_GATEWAY_URL}/system/functions`;
    axios
        .post(url, payload)
        .then((resp) => resolve(resp.data))
...
//# sourceMappingURL=faasApi.js.map