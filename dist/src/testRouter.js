...
const getDestHandler = (version, destination) => require(`./${version}/destinations/${destination}/transform`);
        ...
        await Promise.all(events.map(async (event) => {
            ...
            if (stage.user_transform) {
                ...
                if (transformationVersionId) {
                    try {
                        const destTransformedEvents = await userTransformHandler()([ev], transformationVersionId, librariesVersionIDs);
