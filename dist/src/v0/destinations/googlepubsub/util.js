"use strict";
const { getHashFromArray, getValueFromMessage, isDefinedAndNotNull, isDefinedAndNotNullAndNotEmpty, } = require('../../util');
...
const getTopic = (event) => {
    ...
    return ((message.event ? hashMap[message.event.toLowerCase()] : null) ||
...
const createAttributesMetadata = (message, { Config }) => {
    ...
    const attributeKeys = (message.event ? attributesMap[message.event.toLowerCase()] : null) ||
