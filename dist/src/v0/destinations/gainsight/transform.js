...
const { identifyMapping, groupMapping, IDENTIFY_EXCLUSION_KEYS, GROUP_EXCLUSION_KEYS, ENDPOINTS, } = require('./config');
const { constructPayload, defaultRequestConfig, getValueFromMessage, extractCustomFields, defaultPutRequestConfig, removeUndefinedAndNullValues, defaultPostRequestConfig, getHashFromArray, getDestinationExternalID, simpleProcessRouterDest, } = require('../../util/index');
const { searchGroup, createGroup, updateGroup, renameCustomFieldsFromMap, getConfigOrThrowError, } = require('./util');
...
const identifyResponseBuilder = (message, { Config }) => {
    ...
    payload = extractCustomFields(message, payload, ['traits', 'context.traits'], IDENTIFY_EXCLUSION_KEYS);
