...
const searchGroup = async (groupName, Config) => {
    let resp;
    try {
        resp = await axios.post(`${ENDPOINTS.groupSearchEndpoint(Config.domain)}`, getLookupPayload(groupName), {
            headers: {
...
const createGroup = async (payload, Config) => {
    let resp;
    try {
        resp = await axios.post(`${ENDPOINTS.groupCreateEndpoint(Config.domain)}`, {
            records: [payload],
        }, {
            headers: {
                Accesskey: Config.accessKey,
...
const updateGroup = async (payload, Config) => {
    let resp;
    try {
        resp = await axios.put(`${ENDPOINTS.groupUpdateEndpoint(Config.domain)}`, {
            records: [payload],
        }, {
            headers: {
                Accesskey: Config.accessKey,
