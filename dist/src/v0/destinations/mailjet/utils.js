...
const { constructPayload, getHashFromArray, getIntegrationsObj, getDestinationExternalID, } = require('../../util');
...
const createOrUpdateContactResponseBuilder = (message, destination) => {
    const createOrUpdateContactPayload = constructPayload(message, MAPPING_CONFIG[CONFIG_CATEGORIES.CREATE_OR_UPDATE_CONTACT.name]);
