...
const { isEmptyObject, constructPayload, defaultRequestConfig, extractCustomFields, defaultPutRequestConfig, removeUndefinedAndNullValues, defaultPostRequestConfig, getHashFromArray, getFieldValueFromMessage, getValueFromMessage, simpleProcessRouterDest, getIntegrationsObj, } = require('../../util');
const { renameCustomFields, objectExists, createAccount, updateAccount, formatEventProps, } = require('./util');
const { ENDPOINTS, USER_EXCLUSION_FIELDS, ACCOUNT_EXCLUSION_FIELDS, trackMapping, groupMapping, identifyMapping, } = require('./config');
...
const identifyResponseBuilder = async (message, { Config }) => {
    ...
    customAttributes = extractCustomFields(message, customAttributes, ['traits', 'context.traits'], USER_EXCLUSION_FIELDS);
...
const newGroupResponseBuilder = async (message, { Config }) => {
    ...
    let customAttributes = {};
    customAttributes = extractCustomFields(message, customAttributes, ['traits'], ACCOUNT_EXCLUSION_FIELDS);
