...
const formatConfig = (destination) => ({
    ID: destination.ID,
    ...destination.Config,
    customActivityEventMap: getHashFromArray(destination.Config.customActivityEventMap, 'from', 'to', false),
    customActivityPropertyMap: getHashFromArray(destination.Config.customActivityPropertyMap, 'from', 'to', false),
    customActivityPrimaryKeyMap: getHashFromArray(destination.Config.customActivityPrimaryKeyMap, 'from', 'to', false),
