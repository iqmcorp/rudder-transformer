...
const { constructPayload, removeUndefinedAndNullValues, extractCustomFields, isEmptyObject, getValueFromMessage, isObject, isDefinedAndNotNull, } = require('../../util');
        ...
        items.forEach((item, index) => {
            ...
            if (itemPayload.product_id &&
                ...
                if (!itemPayload.properties) {
                    let customFields = {};
                    customFields = extractCustomFields(item, customFields, 'root', LINEITEMS_EXCLUSION_FIELDS);
                ...
                logger.error(`item at index ${index} dropped. Product id , quantity and either unit_price or subtotal are required.`);
            }
        });
    }
    return itemList;
