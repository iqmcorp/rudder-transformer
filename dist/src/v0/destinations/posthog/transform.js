...
const { defaultRequestConfig, getBrowserInfo, getDeviceModel, constructPayload, defaultPostRequestConfig, ErrorMessage, isValidUrl, stripTrailingSlash, isDefinedAndNotNull, removeUndefinedAndNullValues, simpleProcessRouterDest, } = require('../../util');
...
const responseBuilderSimple = (message, category, destination) => {
    ...
    response.endpoint = `${stripTrailingSlash(destination.Config.yourInstance) || DEFAULT_BASE_ENDPOINT}/batch`;
