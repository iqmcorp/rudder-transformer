...
const scaAudienceRespHandler = (destResponse, stageMsg) => {
    ...
    throw new NetworkError(`${response.error?.message} ${stageMsg}`, status, {
...
const responseHandler = (destinationResponse) => {
    ...
    scaAudienceRespHandler(destinationResponse, 'during snapchat_custom_audience response transformation');
    return undefined;
};
