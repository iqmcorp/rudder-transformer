...
const { defaultRequestConfig, constructPayload, defaultPostRequestConfig, defaultBatchRequestConfig, removeUndefinedAndNullValues, getErrorRespEvents, getSuccessRespEvents, handleRtTfSingleEventError, } = require('../../util');
    ...
    inputs.forEach((event) => {
        try {
            if (event.message.statusCode) {
                ...
                }, identifyEventChunks, eventResponseList);
            }
        }
        catch (error) {
