...
const { defaultRequestConfig, getDestinationExternalID, constructPayload, defaultPostRequestConfig, removeUndefinedNullEmptyExclBoolInt, simpleProcessRouterDest, } = require('../../util');
const { validatePriority, customFieldsBuilder, getListOfAssignees, checkEventIfUIMapped, } = require('./util');
...
const trackResponseBuilder = async (message, destination) => {
    ...
    const customFields = await customFieldsBuilder(keyToCustomFieldName, properties, listId, apiToken);
