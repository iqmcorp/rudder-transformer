...
const getContactDetailsEndpoint = (identifier) => `${BASE_ENDPOINT_MAIN}/${VERSION_MAIN}/contacts/${identifier}`;
const getUnlinkContactEndpoint = (listId) => `${BASE_ENDPOINT_MAIN}/${VERSION_MAIN}/contacts/lists/${listId}/contacts/remove`;
