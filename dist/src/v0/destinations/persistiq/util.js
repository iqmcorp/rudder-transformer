...
const { getFieldValueFromMessage, getHashFromArray, constructPayload, flattenMultilevelPayload, } = require('../../util');
...
const buildLeadPayload = (message, traits, Config) => {
    ...
    const configPayload = constructPayload(message, mappingConfig[fileConfigCategories.IDENTIFY.name]);
    ...
    const customPersistIqAttributes = flattenMultilevelPayload(getAttributes(persistIqAttributesMap, traits, identifySourceKeys));
