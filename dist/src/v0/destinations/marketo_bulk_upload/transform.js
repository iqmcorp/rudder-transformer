"use strict";
const { getHashFromArray, getFieldValueFromMessage, simpleProcessRouterDest, defaultRequestConfig, } = require('../../util');
...
function responseBuilderSimple(message, destination) {
  ...
  */
    const fieldHashmap = getHashFromArray(destination.Config.columnFieldsMapping, 'to', 'from', false);
