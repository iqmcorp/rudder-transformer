...
let noOfFields = readline.question('Number of fields in Schema in addition to USER_ID, TIMESTAMP,ITEM_ID ');
const columns = [];
const type = [];
...
let schema = '{"type": "record","name": "Interactions","namespace": "com.amazonaws.personalize.schema","fields": [{"name": "USER_ID","type": "string"},{"name": "ITEM_ID","type": "string"},{"name": "TIMESTAMP","type": "long" }'; // ], "version": "1.0"}'
if (noOfFields > 0) {
...
//# sourceMappingURL=create-trackingid.js.map