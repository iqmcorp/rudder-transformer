...
const { defaultPostRequestConfig, defaultRequestConfig, removeUndefinedAndNullValues, getFieldValueFromMessage, isDefinedAndNotNull, isAppleFamily, simpleProcessRouterDest, } = require('../../util');
            ...
            if (rudderProperty === 'products') {
                ...
                for (let i = 0; i < rudderPropertiesObj.products.length; i += 1) {
                    ...
                    Object.keys(product).forEach((productProp) => {
                        const { contentItemsObj, eventDataObj, customDataObj } = mapPayload(category, productProp, product);
                ...
                const { contentItemsObj, eventDataObj, customDataObj } = mapPayload(category, rudderProperty, rudderPropertiesObj);
                Object.assign(productObj, contentItemsObj);
                Object.assign(eventData, eventDataObj);
                Object.assign(customData, customDataObj);
            }
