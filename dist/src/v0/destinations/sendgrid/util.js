...
const { isEmpty, isObject, isEmptyObject, getHashFromArray, constructPayload, isHttpStatusSuccess, getValueFromMessage, defaultPutRequestConfig, getFieldValueFromMessage, getDestinationExternalID, removeUndefinedAndNullValues, removeUndefinedAndNullAndEmptyValues, } = require('../../util');
...
const createMailSettings = (payload, message, Config) => {
    ...
    updatedPayload.mail_settings.footer = removeUndefinedAndNullValues(updatedPayload.mail_settings.footer);
...
const createTrackSettings = (payload, Config) => {
    ...
    if (!updatedPayload.tracking_settings.click_tracking.enable &&
