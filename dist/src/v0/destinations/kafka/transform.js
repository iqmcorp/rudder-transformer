...
const { getIntegrationsObj, getHashFromArray, removeUndefinedAndNullValues, } = require('../../util');
...
const process = (event) => {
    ...
    const topic = integrationsObj?.topic || filterConfigTopics(message, destination) || destination.Config?.topic;
