...
const formatDestinationConfig = (config) => ({
    ...
    productMerchEventToAdobeEvent: getHashFromArray(config.productMerchEventToAdobeEvent, 'from', 'to', false),
    eventMerchProperties: config.eventMerchProperties,
    eventMerchEventToAdobeEvent: getHashFromArray(config.eventMerchEventToAdobeEvent, 'from', 'to', false),
    rudderEventsToAdobeEvents: getHashFromArray(config.rudderEventsToAdobeEvents, 'from', 'to', false),
