...
const { defaultRequestConfig, constructPayload, isDefinedAndNotNull, getIntegrationsObj, removeUndefinedAndNullValues, isDefinedAndNotNullAndNotEmpty, simpleProcessRouterDest, } = require('../../util');
...
const process = async (event) => {
    ...
    switch (messageType) {
        ...
        case EventType.SCREEN: {
            ...
            message.event = `Viewed ${eventCategory ? `${eventCategory} ` : ''}${name ? `${name} ` : ''}${evtType}`;
