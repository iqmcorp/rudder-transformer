...
const { defaultRequestConfig, constructPayload, removeUndefinedAndNullValues, getFieldValueFromMessage, simpleProcessRouterDest, defaultPutRequestConfig, defaultDeleteRequestConfig, } = require('../../util');
...
const groupResponseBuilder = (message, Config) => {
    ...
    if (traits.operation && traits.operation !== 'remove' && traits.operation !== 'add') {
        throw new InstrumentationError(`${traits.operation} is invalid for Operation field. Available are add or remove.`);
    }
