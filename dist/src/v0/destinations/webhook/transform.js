...
const { defaultPostRequestConfig, defaultPutRequestConfig, defaultPatchRequestConfig, defaultGetRequestConfig, defaultRequestConfig, getFieldValueFromMessage, flattenJson, isDefinedAndNotNull, getHashFromArray, simpleProcessRouterDest, defaultDeleteRequestConfig, getIntegrationsObj, } = require('../../util');
...
const processEvent = (event) => {
    ...
    if (url) {
        ...
        //   return event;
        // }
        if ((appendPath && typeof appendPath === 'string') ||
            (integrationsObj &&
