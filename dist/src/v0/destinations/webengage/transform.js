...
const { CONFIG_CATEGORIES, MAPPING_CONFIG, WEBENGAGE_IDENTIFY_EXCLUSION, ENDPOINT, } = require('./config');
const { defaultRequestConfig, constructPayload, defaultPostRequestConfig, ErrorMessage, simpleProcessRouterDest, extractCustomFields, } = require('../../util');
...
const responseBuilder = (message, category, { Config }) => {
    ...
    if (category.type === 'identify') {
        ...
        payload = {
            ...payload,
            attributes: extractCustomFields(message, customAttributes, ['context.traits', 'traits'], WEBENGAGE_IDENTIFY_EXCLUSION),
        };
