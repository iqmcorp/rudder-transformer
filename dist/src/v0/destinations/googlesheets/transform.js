...
const { getValueFromMessage, getSuccessRespEvents, handleRtTfSingleEventError, checkInvalidRtTfEvents, } = require('../../util');
...
const processRouterDest = async (inputs, reqMetadata) => {
    ...
    return [
        getSuccessRespEvents(batchedResponse, inputs.map((input) => input.metadata), inputs[0].destination, true),
        ...errorRespList,
    ];
};
