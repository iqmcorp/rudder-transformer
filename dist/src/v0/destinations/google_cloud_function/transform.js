...
const { defaultRequestConfig, defaultPostRequestConfig, getSuccessRespEvents, checkInvalidRtTfEvents, handleRtTfSingleEventError, } = require('../../util');
...
const processRouterDest = async (inputs, reqMetadata) => {
    ...
    const processedSuccessRespList = successResponseList.map((e) => getSuccessRespEvents(e.message, [e.metadata], e.destination));
