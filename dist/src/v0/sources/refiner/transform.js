...
const identifyMapping = JSON.parse(fs.readFileSync(path.resolve(__dirname, './identifyMapping.json'), 'utf-8'));
const trackMapping = JSON.parse(fs.readFileSync(path.resolve(__dirname, './trackMapping.json'), 'utf-8'));
const groupMapping = JSON.parse(fs.readFileSync(path.resolve(__dirname, './groupMapping.json'), 'utf-8'));
