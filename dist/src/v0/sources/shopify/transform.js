...
const { getShopifyTopic, createPropertiesForEcomEvent, getProductsListFromLineItems, extractEmailFromPayload, setAnonymousIdorUserIdFromDb, setAnonymousId,
// checkForValidRecord,
 } = require('./util');
...
const { INTEGERATION, MAPPING_CATEGORIES, IDENTIFY_TOPICS, ECOM_TOPICS, RUDDER_ECOM_MAP, SUPPORTED_TRACK_EVENTS, SHOPIFY_TRACK_MAP, useRedisDatabase, } = require('./config');
