...
const voterMapping = JSON.parse(fs.readFileSync(path.resolve(__dirname, './voterMapping.json'), 'utf-8'));
const authorMapping = JSON.parse(fs.readFileSync(path.resolve(__dirname, './authorMapping.json'), 'utf-8'));
/**
