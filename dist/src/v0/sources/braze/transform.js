...
const eventNameMap = JSON.parse(fs.readFileSync(path.resolve(__dirname, './eventMapping.json'), 'utf-8'));
// ignored properties
// to be deleted from the field `event.properties` as already mapped
// using mapping.json
const ignoredProperties = JSON.parse(fs.readFileSync(path.resolve(__dirname, './ignore.json'), 'utf-8'));
