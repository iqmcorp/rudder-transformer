...
const responseHandler = (destinationResponse, dest) => {
    ...
    if (!isHttpStatusSuccess(status)) {
        throw new NetworkError(`[Generic Response Handler] Request failed for destination ${dest} with status: ${status}`, status, {
...
//# sourceMappingURL=genericNetworkHandler.js.map